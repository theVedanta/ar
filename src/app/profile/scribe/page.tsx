...
export default function ScribeProfilePage() {
    ...
    const handleExamTypeChange = (examType: string, checked: boolean) => {
        if (checked) {
            setFormData((prev) => ({
                ...prev,
                examTypes: [...prev.examTypes, examType],
            }));
        } else {
            setFormData((prev) => ({
                ...prev,
                examTypes: prev.examTypes.filter((e) => e !== examType),
            }));
        }
    };
    ...
    const handleAvailabilityChange = (
        ...
        if (checked) {
            ...
            setFormData((prev) => ({
                ...
                availability: {
                    ...prev.availability,
                    [type]: prev.availability[type].filter(
                        (item) => item !== value
                    ),
                },
            }));
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-2xl">
                            Scribe Profile Setup
                        </CardTitle>
                        <CardDescription>
                            Help us understand your expertise and availability
                            to match you with students who need your help.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        {examTypes.map((examType) => (
                                            ...
                                            >
                                                <Checkbox
                                                    id={`exam-${examType}`}
                                                    checked={formData.examTypes.includes(
                                                        examType
                                                    )}
                                                    onCheckedChange={(
                                                        checked
                            ...
                            {/* Handwriting Sample */}
                            {(formData.examPreference === "written" ||
                                formData.examPreference === "both") && (
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        {timeSlots.map((slot) => (
                                            ...
                                            >
                                                <Checkbox
                                                    id={`slot-${slot}`}
                                                    checked={formData.availability.timeSlots.includes(
                                                        slot
                                                    )}
                                                    onCheckedChange={(
                                                        checked
                            ...
                            <div className="flex items-start space-x-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                        setFormData((prev) => ({
                                            ...prev,
                                            ethicsAgreement: checked as boolean,
                                        }))
                                    }
                                    required
                                />
                                ...
                                >
                                    I agree to the scribe ethics and guidelines.
                                    I understand my responsibilities as a
                                    volunteer scribe and commit to maintaining
                                    confidentiality and providing fair
                                    assistance. *
                                </Label>
                            </div>
