...
import { Star, Calendar, Clock, MapPin, User, CheckCircle, XCircle, AlertCircle } from "lucide-react"
      ...
      <header className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold text-gray-900">Scribe Dashboard</h1>
      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs defaultValue="requests" className="space-y-6">
          ...
          <TabsContent value="requests" className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-semibold">Students Needing Help</h2>
              <Badge variant="secondary">{requests.filter((r) => r.status === "pending").length} new requests</Badge>
            </div>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <CardDescription>
                            {request.age} years • {request.class} • Requested {request.requestedAt}
                          </CardDescription>
                        </div>
                      </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <h4 className="font-medium text-sm text-gray-600 mb-2">Exam Details</h4>
                          <p className="text-sm">{request.examName}</p>
                          <p className="text-xs text-gray-500">{request.examType}</p>
                        </div>
                        <div>
                      ...
                      {request.genderPreference !== "No Preference" && (
                        <div className="text-sm text-gray-600">
                          <strong>Gender Preference:</strong> {request.genderPreference}
                        </div>
                      )}
          ...
          <TabsContent value="history" className="space-y-6">
            <h2 className="text-xl font-semibold">Scribing History</h2>
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 border rounded-lg">
                    <div>
                      <h4 className="font-medium">Helped Ravi Kumar</h4>
                      <p className="text-sm text-gray-600">Mathematics • CBSE 12th • Nov 15, 2024</p>
                    </div>
                    <div className="text-right">
                  ...
                  <div className="flex justify-between items-center p-4 border rounded-lg">
                    <div>
                      <h4 className="font-medium">Helped Priya Singh</h4>
                      <p className="text-sm text-gray-600">Physics • JEE Mains • Nov 10, 2024</p>
                    </div>
                    <div className="text-right">
                      <div className="flex items-center gap-1 mb-1">
                        <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label className="text-sm font-medium text-gray-600">Exam Preference</Label>
